...
{
    public partial class CrearAporteGuardian : System.Web.UI.Page
    {
        //Variables globales necesarias
        //ObtenerTipoAporte tipoAporte = new ObtenerTipoAporte();
        //AgregarAporte aporte = new AgregarAporte();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                //Obtenemos los puntos de la persona
        ...
        protected void btnAgregarAporte_Click(object sender, EventArgs e)
        {
               ...
               fileExtension.ToLower() == ".png")
            {
                ...
                //Actualiza los puntos del usuario y modifica la cookie
                ...
                //Se agregan los datos restantes
