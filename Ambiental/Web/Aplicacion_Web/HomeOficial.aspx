<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeOficial.aspx.cs" Inherits="Aplicacion_Web.HomeOficial" %>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <!--end  Welcome-->
                <br />
                <asp:Label ID="Label8" runat="server" Font-Size="Large" ForeColor="#339966" Text="Crear soluciones a las denuncias que fueron aprobadas por los jueces."></asp:Label>
                <br />
                <br />
                <br />
                ...
                <br />
                <br />
                <asp:Label ID="Label9" runat="server" Font-Size="Large" ForeColor="#339966" Text="Crear Solución: Se realiza una consulta y selecciona una denuncia para luego crear una solución de la misma. Es importante que tome la foto previamente para agregarla a la solución."></asp:Label>
                <br />
                <br />
